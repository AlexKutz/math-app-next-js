...
export function UserMenu() {
  ...
  return (
    <div className='relative' ref={menuRef}>
      ...
      <div
        className={`absolute top-11 right-0 z-50 mt-2 w-48 origin-top-right transform-gpu rounded-md border border-gray-200 bg-white py-1 antialiased shadow-lg transition-all duration-200 ease-out dark:border-gray-700 dark:bg-background dark:shadow-sm dark:shadow-[#8b72443f] ${
          isOpen
