  ...
  return (
    <div className='mb-6 flex flex-wrap gap-1.5'>
      {tasks.map((task, index) => {
        ...
        const baseStyles =
          'flex h-9 w-9 cursor-pointer items-center justify-center rounded-md border text-sm font-bold transition-all antialiased transform-gpu';
        ...
        const currentStyles = isCurrent
          ? 'scale-105 ring-2 ring-blue-500 ring-offset-2 dark:ring-blue-400 dark:ring-offset-black'
          : '';
