...
export function TableOfContents({ headings }: TableOfContentsProps) {
  ...
  return (
    <>
      ...
      <nav className="border border-amber-300 hidden lg:block fixed left-[calc((100vw-55rem-3vw)/2-18rem)] top-1/6 w-56 xl:w-64 h-[calc(100vh-5rem)] overflow-y-auto px-4 py-6 z-10 lg:-translate-x-[calc((100vw-1536px)/2)] 2xl:translate-x-0">
        <h2 className="mb-4 text-lg font-semibold text-foreground">Зміст уроку</h2>
