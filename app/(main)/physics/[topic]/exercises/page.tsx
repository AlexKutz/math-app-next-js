...
export default async function Page({
  ...
  const tasksDir = join(process.cwd(), 'content/physics', topic, 'tasks');
  ...
  const breadcrumbItems = [
    { label: 'Фізика', href: '/physics' },
    { label: frontmatter.title || topic, href: `/physics/${topic}/lesson` },
    { label: 'Вправи' },
  ];
